...
* [aiken-lang/stdlib](https://github.com/aiken-lang/stdlib) ⭐ 58 | 🐛 7 | 🌐 Aiken | 📅 2026-09-23 - The official standard library
...
* [aiken-lang/fuzz](https://github.com/aiken-lang/fuzz) ⭐ 11 | 🐛 4 | 🌐 Aiken | 📅 2026-09-22 - For writing Fuzzers (a.k.a generators) for property-based testing in Aiken
...
* [Seedelf](https://github.com/logical-mechanism/Seedelf-Wallet) ⭐ 14 | 🐛 0 | 🌐 Rust | 📅 2026-09-26 A Cardano Stealth Wallet
...
* [MeshJS smart contracts collection](https://github.com/MeshJS/mesh/tree/main/packages/mesh-contract/src) ⭐ 273 | 🐛 83 | 🌐 TypeScript | 📅 2026-09-18 - A series of smart contracts  with full integration with MeshJS, offering code examples and explanations
